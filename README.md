...
[Dashboard Preview](Mobile_Sales_Dashboard.png)
...
This Power BI dashboard provides **actionable insights** into mobile phone sales with real-time, interactive visualizations:
...
- **India Map (Geospatial Sales)** – Bubble-sized sales by city (Delhi, Mumbai, Bangalore, etc.)
- **Monthly Quantity Trend** – Line chart with peak in **July (1,700 units)**
- **Customer Ratings** – 5⭐ leads with **311 reviews**
- **Payment Method Distribution** – Donut chart  
  - 🟠 **UPI:** 26.25%  
  - 🔵 **Debit Card:** 25.89%  
  - 🟣 **Credit Card:** 25.03%  
  - 🟡 **Cash:** 22.83%
- **Brand Leaderboard** – Table & bar chart  
  1. 🍎 **Apple** – 161.6M  
  2. **OnePlus** – 153.7M  
  3. **Samsung** – 160.0M  
  4. **Vivo** – 150.1M  
...
- **Top Models by Revenue**  
  ...
  - **OnePlus Nord** – **58M**  
  - **Galaxy Note** – **56M**
- **Weekly Sales Pattern** – Highest on **Sunday (115M)**, lowest on **Wednesday (105M)**
...
|------|-------------|---------------|
| **Power BI File** | `.pbix` – Fully interactive dashboard | [![Download PBIX](https://img.shields.io/badge/📄_Download_PBIX-0078D4?style=for-the-badge&logo=microsoft)](https://github.com/YOUR_USERNAME/YOUR_REPO/releases/download/v1.0/Mobile_Sales_Dashboard.pbix) |
| **Raw Data** | `.xlsx` – Original Excel dataset | [![Download Excel](https://img.shields.io/badge/📊_Download_Excel-217346?style=for-the-badge&logo=microsoft-excel)](https://github.com/YOUR_USERNAME/YOUR_REPO/releases/download/v1.0/Mobile_Sales_Data.xlsx) |
